export class SpecialInput extends HTMLInputElement {                        // définit un design spécifique pour tous les input du site - HTMLInputElement est un élément prédéfini en JS
    constructor(_css, _type, _placeholder, _id, _class, _name, _value) {    // définit un constructeur avec les propriétés de l'input qui seront entrées en argument
      super();                                                              // crée tout ce qui se trouve dans le HTMLInputElement  
      this.type = _type;
